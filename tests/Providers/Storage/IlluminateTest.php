...
namespace luochuan\JWTAuth\Test\Providers\Storage;

use Illuminate\Contracts\Cache\Repository;
use Mockery;
use luochuan\JWTAuth\Providers\Storage\Illuminate as Storage;
use luochuan\JWTAuth\Test\AbstractTestCase;
use luochuan\JWTAuth\Test\Stubs\TaggedStorage;
...
class IlluminateTest extends AbstractTestCase
{
    ...
    /**
     * @var \luochuan\JWTAuth\Providers\Storage\Illuminate
     */
    protected $storage;
    ...
    private function emulateTags()
    {
        ...
        $this->cache->shouldReceive('tags')->with('luochuan.jwt')->once()->andReturn(Mockery::self());
    }
